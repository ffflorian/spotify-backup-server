...
},{"process":"../node_modules/process/browser.js"}],"js/config.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/spotmybackup.js":[function(require,module,exports) {
"use strict";
...
function refreshTrackData(callback) {
  if (!isExporting && !isImporting) {
    isExporting = true;
    resetCounter();
    (0, _jquery.default)('#pnlLoadingAccount').show();
    (0, _jquery.default)('#loadingTitle').html('Please wait. Loading your playlists and tracks ...');
    refreshPlaylist(function () {
      refreshMyMusicTracks(function () {
        // refreshStarredTracks(function () {
        (0, _jquery.default)('#loadingTitle').html('Finished loading, you now might want to export or import.');
        isExporting = false;
        callback(); // });
      });
    });
...
function refreshProgress() {
  (0, _jquery.default)('#globalStep').html(globalStep);
  (0, _jquery.default)('#playlistStep').html(playlistStep);
  (0, _jquery.default)('#playlistTotal').html(playlistTotal);
  (0, _jquery.default)('#trackStep').html(trackStep);
  (0, _jquery.default)('#trackTotal').html(trackTotal);
  var progress = 0;
  ...
  (0, _jquery.default)('#progressBar').css('width', progress + '%');

  if (typeof collections !== 'undefined' && !makingChanges) {
    var set = collectionProperties(collections);
    (0, _jquery.default)('#loadingPlaylists').html('' + set.playlistCount + ' playlists');
    (0, _jquery.default)('#loadingTracks').html('' + set.trackCount + ' tracks');
  }

  if (typeof importColl !== 'undefined') {
    var set2 = collectionProperties(importColl);
    (0, _jquery.default)('#filePlaylists').html('' + set2.playlistCount + ' playlists');
    (0, _jquery.default)('#fileTracks').html('' + set2.trackCount + ' tracks');
  }
...
function login() {
  ...
  var set = {
    client_id: _config.default.client_id,
  ...
  authWindow = window.open('https://accounts.spotify.com/authorize?' + urlEncodeSet(set), 'Spotify', 'menubar=no,location=no,resizable=no,scrollbars=no,status=no, width=' + width + ', height=' + height + ', top=' + top + ', left=' + left);
}

function authCallback(event) {
  if (event.origin !== _config.default.uri) {
...
function readFile(evt) {
  ...
  if (f) {
    (0, _jquery.default)('#fileName').html(f.name);
    var r = new FileReader();

    r.onload = function (e) {
      var json = e.target.result;
      importColl = JSON.parse(json);
      (0, _jquery.default)('#pnlFile').hide();
      (0, _jquery.default)('#pnlFileInfo').show();
      (0, _jquery.default)('#pnlUpload').show();
      compareEverything();
    };
...
function collTrackCount(coll) {
  ...
  var keys = _underscore.default.keys(coll.playlists);

  _jquery.default.each(keys, function (index, value) {
...
function compareEverything() {
  if (!isImporting && !isExporting) {
    ...
    if (typeof importColl !== 'undefined') {
      playlistTotal = collPlaylistCount(importColl); // TONOTDO:compare starred -> can not really do that since there is no api to manipulate those
      ...
      makeSureImportedStarredExists(function (proceed) {
        ...
        playlistStep += 1; // compare other playlists

        var playlistNames = _underscore.default.keys(importColl.playlists);
...
function handleTrackUpload() {
  ...
  if (trackTotal > 0) {
    (0, _jquery.default)('#progressBar').show();
...
function handlePlaylistRequestsWithTimeout(arr, callback) {
  ...
  }, _config.default.slowdown_import);
}
...
function handlePlaylistRequests(arr, callback) {
  ...
  if (url) {
    ...
    _jquery.default.ajax({
      ...
      success: function success(response) {// collections.playlists[response.name] = {
        //     id: response.id,
        //     uri: response.uri
        // };
      },
...
function uriInTracks(uri, tracks, addCallback) {
  ...
  _jquery.default.each(tracks, function (index, value) {
    if (value.uri == uri) {
      found = true;
    }
  });
...
function compareUriTracks(imported, stored, addCallback) {
  _jquery.default.each(imported, function (index, value) {
    var found = false;

    _jquery.default.each(stored, function (index2, value2) {
...
function bindControls() {
  (0, _jquery.default)('#btnImport').click(function () {
    (0, _jquery.default)('#pnlAction').hide();
    (0, _jquery.default)('#pnlImport').show();
  });
  (0, _jquery.default)('#btnExport').click(function () {
    var json = JSON.stringify(collections);
    var d = new Date();
    var time = '@' + d.getFullYear() + '_' + (d.getMonth() + 1) + '_' + d.getDate();
    download(name + time + '.json', json);
  });
  (0, _jquery.default)('#fileImport').change(readFile);
}

function handleAuth(accessToken) {
  token = accessToken; // fetch my public playlists
  ...
  _jquery.default.ajax({
    ...
    success: function success(response) {
      ...
      userId = user_id;
      name = user_id;
      (0, _jquery.default)('#userName').html(name);
      (0, _jquery.default)('#pnlLoggedOut').hide();
      refreshTrackData(function () {
        (0, _jquery.default)('#pnlAction').show();
      });
    }
  });
}
...
function loadTrackChunksWithTimeout(url, arr, callback, timeout) {
  ...
  }, _config.default.slowdown_export);
}
...
function loadTrackChunks(url, arr, callback) {
  _jquery.default.ajax({
    ...
    success: function success(data) {
      ...
      if ('items' in data) {
        _jquery.default.each(data.items, function (index, value) {
          if (value.track !== null) {
            arr.push({
              id: value.track.id,
              uri: value.track.uri
...
window.onload = function () {
  if (navigator.userAgent.indexOf('MSIE') !== -1 || navigator.appVersion.indexOf('Trident/') > 0) {
    // MSIE
    (0, _jquery.default)('#pnlLoggedOut').html('Please use Firefox or Chrome, due to a bug in Internet Explorer');
  } else {
    (0, _jquery.default)('#login').click(login);
    window.addEventListener('message', authCallback, false);
    bindControls();
    refreshProgress();
  }
};
},{"jquery":"../node_modules/jquery/dist/jquery.js","./config":"js/config.js","underscore":"../node_modules/underscore/underscore.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/spotmybackup.js"], null)
//# sourceMappingURL=/spotmybackup.da4f730f.map